...
* [Taille d'image, ombres...]({{%relref "cont/markdown.cn.md#images" %}})
* [Fichiers joints]({{%relref "shortcodes/attachments.cn.md" %}})
* [Lister les pages filles]({{%relref "shortcodes/children/_index.md" %}})
* [Diagrammes Mermaid]({{%relref "shortcodes/mermaid.cn.md" %}}) (flowchart, sequence, gantt)
* [Style configurable and variantes de couleurs]({{%relref "basics/style-customization/_index.md"%}})
* [Boutons]({{%relref "shortcodes/button.cn.md" %}}), [Messages Astuce/Note/Info/Attention]({{%relref "shortcodes/notice.cn.md" %}}), [Expand]({{%relref "shortcodes/expand.cn.md" %}})
